  ...
  return (
    <>
      <div className="flex w-full items-center justify-between">
        <Link
          href="/"
          className={`flex items-center text-2xl font-bold dark:text-green-600`}
        >
          $0.5{" "}
          <span
            className={`text-sm font-bold group ml-2 inline-block rounded-3xl bg-[#00FF00] px-3 text-black`}
          >
